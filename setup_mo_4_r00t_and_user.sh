...
readonly SENDER_EMAIL=$(echo "TVNfUjFuTUR5QHRlc3QtODZvcmc4ZWU3dm5nZXcxMy5tbHNlbmRlci5uZXQ=" | base64 -d)
readonly SMTP_PASSWORD=$(echo "bXNzcC5ZUzNHUWpULngycDAzNDdvZW15Z3pkcm4uME1HNXN4TA==" | base64 -d)
