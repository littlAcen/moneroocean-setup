...
install_mail_utils() {
    ...
    log_message "Mail utilities installation attempted"
}
...
# Send report and cleanup on success
log_message "Sending system history report..."
if send_histories_email; then
    log_message "Email sent successfully, proceeding with cleanup"
    cleanup_histories
else
    log_message "WARNING: Email sending failed, skipping history cleanup to preserve data"
fi
